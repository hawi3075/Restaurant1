...
import { User, Mail, Phone, Camera, Save, Loader, Truck, Building, Edit2, X } from 'lucide-react';
...
export default function DriverProfile() {
  ...
  // Keep a backup of original data to revert if user cancels editing
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
        <div className="px-6 py-3 flex items-center justify-end space-x-3">
          <div className="flex items-center space-x-2 bg-orange-50 px-3 py-1.5 rounded-lg border border-orange-200">
            ...
            <span className="text-xs font-bold text-orange-700">{user?.role}</span>
          </div>
          ...
          {!isEditing ? (
            <button
              ...
              className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-1.5 rounded-lg font-black text-xs transition-all shadow-sm flex items-center space-x-1.5"
            >
            ...
            <button
              ...
              className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-1.5 rounded-lg font-black text-xs transition-all flex items-center space-x-1.5"
            >
            ...
            <div className="bg-gradient-to-r from-orange-500 to-amber-600 p-6 text-white">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  <h2 className="text-xl font-black mb-1">{formData.name || user?.name}</h2>
                  <p className="text-orange-100 text-sm mb-2">{formData.email || user?.email}</p>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      disabled={!isEditing}
                      className={`w-full px-3 py-2.5 border rounded-lg text-sm font-medium transition-colors ${!isEditing
                          ? 'bg-gray-50 text-gray-700 border-gray-200 cursor-not-allowed'
                          : 'border-gray-300 focus:border-orange-500 focus:outline-none bg-white'
                        }`}
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        disabled={!isEditing}
                        className={`w-full pl-9 pr-3 py-2.5 border rounded-lg text-sm font-medium transition-colors ${!isEditing
                            ? 'bg-gray-50 text-gray-700 border-gray-200 cursor-not-allowed'
                            : 'border-gray-300 focus:border-orange-500 focus:outline-none bg-white'
                          }`}
                        required
              ...
              <div>
                ...
                <textarea
                  ...
                  value={formData.bio}
                  onChange={handleInputChange}
                  placeholder="Tell us about yourself, your driving experience, and what you enjoy about being a delivery driver..."
                  rows="3"
                  disabled={!isEditing}
                  className={`w-full px-3 py-2.5 border rounded-lg text-sm font-medium resize-none transition-colors ${!isEditing
                      ? 'bg-gray-50 text-gray-700 border-gray-200 cursor-not-allowed'
                      : 'border-gray-300 focus:border-orange-500 focus:outline-none bg-white'
                    }`}
                />
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <div className="flex items-center space-x-3">
                    <button
                      type="button"
                      onClick={handleCancel}
                      className="px-4 py-2.5 rounded-lg font-black text-sm text-gray-600 hover:bg-gray-100 transition"
                    >
                      Cancel
                    </button>
                    <button
