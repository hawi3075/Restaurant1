...
import { getRestaurantImageUrl, getCategoryImageUrl, getFoodImageUrl } from '../../utils/imageUtils';
          ...
          >
            {category.image && (
              <img
                ...
                onError={(e) => { e.target.src = getCategoryImageUrl(null); }}
              />
            )}
                  ...
                  >
                    <div className="relative h-48 overflow-hidden bg-gray-100 dark:bg-gray-800">
                      <img
                        ...
                        onError={(e) => { e.target.src = '/mg1.jpg'; }}
                      />
